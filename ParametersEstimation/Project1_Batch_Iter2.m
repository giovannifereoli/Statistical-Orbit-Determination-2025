...
% ASSIGNMENT:   Project 1 - BATCH - Iter2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear; clc; close;
...
load('state0_deviation_iter1.mat', 'state0_deviation');
...
ylabel('Range Residual $\cdot 1e-4$ (km)', 'Interpreter', 'latex', 'FontSize', 16);
...
grid on;
hold off;
exportgraphics(gca123, 'Prefit_Batch_Iter2.pdf', 'ContentType',...
...
gca10 = figure(10);
set(gca10, 'Position', [100, 100, 1400, 900]); 
colors = lines(19);
subplot(2,2,1);
hold on;
...
ylabel('Position Deviation $\cdot 1e-4$ (km)', 'Interpreter', 'latex', 'FontSize', 14);
...
xlabel('Time (hours)', 'Interpreter', 'latex', 'FontSize', 14);
ylabel('Velocity Deviation $\cdot 1e-7$ (km/s)', 'Interpreter', 'latex', 'FontSize', 14);
legend('show', 'Interpreter', 'latex', 'FontSize', 14, 'Location', 'northeast');
grid on;
hold off;
subplot(2,2,3);
...
xlabel('Time (hours)', 'Interpreter', 'latex', 'FontSize', 14);
ylabel('Deviation $\cdot 1e-4$ (km)', 'Interpreter', 'latex', 'FontSize', 14);
legend('show', 'Interpreter', 'latex', 'FontSize', 14, 'Location', 'northeast');
grid on;
hold off;
...
gca6 = figure(6);
set(gca6, 'Position', [100, 100, 1400, 900]);
subplot(2,1,1);
hold on;
...
save('state0_deviation_iter2.mat', 'state0_deviation');

%% Print out results

% Extract the final covariance matrix
P_initial_batch = results.P_hist(:, :, 1);
